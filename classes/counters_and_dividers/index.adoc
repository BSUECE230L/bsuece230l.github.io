...
=== Answer 2: Close enough, probably, I hope (Ring Counters)
...
For this, we have the Ring Counter. It is a signifcanly more simple, if more
...
.Simple Ring Counter
image:img/ring_counter.drawio.svg[]
...
count of 6) with a modulo divider and by 8 with a ring counter.

For the ring counter, use the T-FlipFlop module you implemented in previous
...
You will be responsible to implmement both the ring counter and the modulo
...
| btnU      | Reset     | IN
| btnC      | Input Clock     | IN
| led[0]    | Ring counter stage 1 | OUT
| led[1]    | Ring counter stage 2 | OUT
| led[2]    | Ring counter stage 2 | OUT
