...
NOTE: For much more detail on this and other things about the Basys3, see xref:https://digilent.com/reference/programmable-logic/basys-3/reference-manual[the reference manual]. The following two images are from this web page.
