...
by demonstrating the function of the Verilog code on the Basys board
to a TA/instructor, answer a few questions, and you get checked off. 
Labs are all designed to be completed within the allotted time.
Partial credit can be awarded by examining code committed to each GitHub project,
if you are unable to complete the assignments during the lab.

In addition to demonstrating in the lab, there will be lab reports to write about each lab. 
Details for these, and how they are graded, will be included with each lab.
